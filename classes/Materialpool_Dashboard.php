...
class Materialpool_Dashboard
{
    ...
    static public function dashboard_page_content()
    {
        ...
        */
        ...
        $title = " Materialpool";
        $classes = "notice-panel-admin-materialpool";
        ...
        <div class="wrap">
            ...
            <div id="notice-panel-admin-materialpool" class="<?php echo esc_attr($classes); ?>" style="
            padding: 10px;
            ...
            font-weight: bold;">
                ...
                <div style="float: left; padding-right: 20px;">
                    ...
                    if (Materialpool_Material::submit_count() > 0) {
                        ?>
                        <a href="<?php echo admin_url("edit.php?post_status=vorschlag&post_type=material"); ?>">Materialvorschläge
                            zur Überprüfung: <?php echo Materialpool_Material::submit_count(); ?></a><br>
                        <?php
                    }
                    ?>
                    <?php
                    if (Materialpool_Contribute::submit_count() > 0) {
                        ?>
                        <a href="<?php echo admin_url("admin.php?page=rw-materialpool%2Fclasses%2FMaterialpool_Contribute.php2"); ?>">Autorenverknüpfungen
                            zur Überprüfung: <?php echo Materialpool_Contribute::submit_count(); ?></a><br>
                        <?php
                    }
                    ?>
                </div>
